...
import { checkPass, handleFound, handleModal, setInput, handleDark } from "./MapSlice";
...
export default function App () {
    ...
    return (
        <div className="map-page">
            <button className={ dark ? "navbar_item-clicked" : "navbar_item"} onClick={() => dispatch(handleDark())}>day/night</button>
                ...
                <div className="modal-window">
                    ...
                    <div className="modal-content">
                        {countries.map((country, i) => {
                            if ((country.marker == "unlocked-point" || country.marker == "dark-unlocked-point") && country.pass == pass) {                                
